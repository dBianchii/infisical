...
import { SecretOverviewFolderRow } from "../SecretOverviewPage/components/SecretOverviewFolderRow";
import { SecretV2MigrationSection } from "../SecretOverviewPage/components/SecretV2MigrationSection";
import { SelectionPanel } from "../SecretOverviewPage/components/SelectionPanel/SelectionPanel";
...
export const SecretOverviewPage = () => {
  ...
  const handleExploreEnvClick = async (slug: string) => {
    ...
    if (envIndex !== -1) {
      router.push({
        pathname: `/${ProjectType.UserSecrets}/[id]/secrets/[env]`,
        query
      });
    }
  };
